...
<!-- Stars Rating -->
<script src="{{ asset('public/assets/js/stars_rating.js') }}"></script>
<!-- Single Image Upload -->
<script src="{{ asset('public/assets/js/single_image_upload.js') }}"></script>
<!-- Multi Images Upload -->
<script src="{{ asset('public/assets/js/multi_images_upload.js') }}"></script>
