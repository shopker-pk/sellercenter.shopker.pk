    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="{{ route('edit_product', $query_product->id) }}">Edit Product</a></li>
            </ol>
        </section>
        <section class="content">
            @include('layouts.messages')
            <form action="{{ route('update_product', $query_product->id) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="box-body pad">
                                        <textarea name="description" id="description" class="form-control wysihtml5" placeholder="Product Description*" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ old('description', $query_product->description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
